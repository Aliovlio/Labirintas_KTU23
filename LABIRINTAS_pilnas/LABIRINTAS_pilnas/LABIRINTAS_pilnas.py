...
def level_3():
    ...
    labirintas = [
     (x,y,x+(18*lang),y ),
     (x,y,x,y+(7*lang) ),    
     (x,y+(8*lang),x,y+(17*lang) ),
     (x+(18*lang),y, x+(18*lang),y+(6*lang) ),
     (x+(18*lang),y+(7*lang), x+(18*lang),y+(17*lang) ),
     (x,y+(17*lang),x+(18*lang),y+(17*lang) ),
     (x+(8*lang),y,x+(8*lang),y+lang ),
     (x+(11*lang),y,x+(11*lang),y+(2*lang) ),
     (x+(14*lang),y,x+(14*lang),y+lang ),
     (x+lang,y+lang,x+lang,y+(4*lang) ),
     (x+(2*lang),y+lang,x+(3*lang), y+lang ),
     (x+(4*lang),y+lang,x+(8*lang), y+lang ),
     (x+(9*lang),y+lang,x+(10*lang), y+lang ),
     (x+(14*lang),y+lang,x+(17*lang), y+lang ),
     (x+(3*lang),y+lang,x+(3*lang), y+(4*lang) ),
     (x+(6*lang),y+lang,x+(6*lang), y+(4*lang) ),
     (x+(9*lang),y+lang,x+(9*lang), y+(2*lang) ),
     (x+(12*lang),y+lang,x+(12*lang), y+(3*lang) ),
     (x+(13*lang),y+lang,x+(13*lang), y+(2*lang) ),
     (x+(3*lang),y+(2*lang),x+(5*lang), y+(2*lang) ),
     (x+(7*lang),y+(2*lang),x+(9*lang), y+(2*lang) ),
     (x+(10*lang),y+(2*lang),x+(12*lang), y+(2*lang) ),
     (x+(13*lang),y+(2*lang),x+(17*lang), y+(2*lang) ),
     (x+(2*lang),y+(2*lang),x+(2*lang), y+(3*lang) ),
     (x+(5*lang),y+(2*lang),x+(5*lang), y+(3*lang) ),
     (x+(7*lang),y+(2*lang),x+(7*lang), y+(5*lang) ),
     (x+(10*lang),y+(2*lang),x+(10*lang), y+(3*lang) ),
     (x+(16*lang),y+(2*lang),x+(16*lang), y+(7*lang) ),
     (x+(17*lang),y+(2*lang),x+(17*lang), y+(3*lang) ),
     (x+(1*lang),y+(3*lang),x+(2*lang), y+(3*lang) ),
     (x+(8*lang),y+(3*lang),x+(10*lang), y+(3*lang) ),
     (x+(13*lang),y+(3*lang),x+(15*lang), y+(3*lang) ),
     (x+(4*lang),y+(3*lang),x+(4*lang), y+(5*lang) ),
     (x+(11*lang),y+(3*lang),x+(11*lang), y+(4*lang) ),
     (x+(14*lang),y+(3*lang),x+(14*lang), y+(7*lang) ),
     (x+(15*lang),y+(3*lang),x+(15*lang), y+(4*lang) ),
     (x,y+(4*lang),x+(1*lang), y+(4*lang) ),
     (x+(2*lang),y+(4*lang),x+(3*lang), y+(4*lang) ),
     (x+(5*lang),y+(4*lang),x+(6*lang), y+(4*lang) ),
     (x+(7*lang),y+(4*lang),x+(8*lang), y+(4*lang) ),
     (x+(9*lang),y+(4*lang),x+(13*lang), y+(4*lang) ),
     (x+(16*lang),y+(4*lang),x+(17*lang), y+(4*lang) ),
     (x+(2*lang),y+(4*lang),x+(2*lang), y+(5*lang) ),
     (x+(5*lang),y+(4*lang),x+(5*lang), y+(5*lang) ),
     (x+(9*lang),y+(4*lang),x+(9*lang), y+(5*lang) ),
     (x+(13*lang),y+(4*lang),x+(13*lang), y+(6*lang) ),
     (x+(1*lang),y+(5*lang),x+(5*lang), y+(5*lang) ),
     (x+(6*lang),y+(5*lang),x+(7*lang), y+(5*lang) ),
     (x+(8*lang),y+(5*lang),x+(9*lang), y+(5*lang) ),
     (x+(10*lang),y+(5*lang),x+(12*lang), y+(5*lang) ),
     (x+(15*lang),y+(5*lang),x+(16*lang), y+(5*lang) ),
     (x+(17*lang),y+(5*lang),x+(18*lang), y+(5*lang) ),
     (x+(6*lang),y+(5*lang),x+(6*lang), y+(6*lang) ),
     (x+(8*lang),y+(5*lang),x+(8*lang), y+(6*lang) ),
     (x+(10*lang),y+(5*lang),x+(10*lang), y+(6*lang) ),
     (x+(17*lang),y+(5*lang),x+(17*lang), y+(6*lang) ),
     (x+(1*lang),y+(6*lang),x+(2*lang), y+(6*lang) ),
     (x+(3*lang),y+(6*lang),x+(6*lang), y+(6*lang) ),
     (x+(7*lang),y+(6*lang),x+(8*lang), y+(6*lang) ),
     (x+(9*lang),y+(6*lang),x+(10*lang), y+(6*lang) ),
     (x+(11*lang),y+(6*lang),x+(13*lang), y+(6*lang) ),
     (x+(14*lang),y+(6*lang),x+(15*lang), y+(6*lang) ),
     (x+(1*lang),y+(6*lang),x+(1*lang), y+(8*lang) ),
     (x+(4*lang),y+(6*lang),x+(4*lang), y+(11*lang) ),
     (x+(9*lang),y+(6*lang),x+(9*lang), y+(9*lang) ),
     (x+(11*lang),y+(6*lang),x+(11*lang), y+(7*lang) ),
     (x+(2*lang),y+(7*lang),x+(3*lang), y+(7*lang) ),
     (x+(5*lang),y+(7*lang),x+(12*lang), y+(7*lang) ),
     (x+(13*lang),y+(7*lang),x+(14*lang), y+(7*lang) ),
     (x+(15*lang),y+(7*lang),x+(18*lang), y+(7*lang) ),
     (x+(2*lang),y+(7*lang),x+(2*lang), y+(9*lang) ),
     (x+(7*lang),y+(7*lang),x+(7*lang), y+(8*lang) ),
     (x+(12*lang),y+(7*lang),x+(12*lang), y+(10*lang) ),
     (x+(13*lang),y+(7*lang),x+(13*lang), y+(10*lang) ),
     (x+(15*lang),y+(7*lang),x+(15*lang), y+(8*lang) ),
     (x,y+(8*lang),x+(1*lang), y+(8*lang) ),
     (x+(3*lang),y+(8*lang),x+(6*lang), y+(8*lang) ),
     (x+(10*lang),y+(8*lang),x+(11*lang), y+(8*lang) ),
     (x+(14*lang),y+(8*lang),x+(15*lang), y+(8*lang) ),
     (x+(6*lang),y+(8*lang),x+(6*lang), y+(9*lang) ),
     (x+(8*lang),y+(8*lang),x+(8*lang), y+(9*lang) ),
     (x+(10*lang),y+(8*lang),x+(10*lang), y+(11*lang) ),
     (x+(11*lang),y+(8*lang),x+(11*lang), y+(9*lang) ),
     (x+(14*lang),y+(8*lang),x+(14*lang), y+(10*lang) ),
     (x+(16*lang),y+(8*lang),x+(16*lang), y+(9*lang) ),
     (x+(17*lang),y+(8*lang),x+(17*lang), y+(13*lang) ),
     (x+(1*lang),y+(9*lang),x+(4*lang), y+(9*lang) ),
     (x+(6*lang),y+(9*lang),x+(8*lang), y+(9*lang) ),
     (x+(15*lang),y+(9*lang),x+(17*lang), y+(9*lang) ),
     (x+(1*lang),y+(9*lang),x+(1*lang), y+(10*lang) ),
     (x+(5*lang),y+(9*lang),x+(5*lang), y+(12*lang) ),
     (x+(15*lang),y+(9*lang),x+(15*lang), y+(10*lang) ),
     (x,y+(10*lang),x+(1*lang), y+(10*lang) ),
     (x+(2*lang),y+(10*lang),x+(3*lang), y+(10*lang) ),
     (x+(5*lang),y+(10*lang),x+(13*lang), y+(10*lang) ),
     (x+(14*lang),y+(10*lang),x+(15*lang), y+(10*lang) ),
     (x+(2*lang),y+(10*lang),x+(2*lang), y+(11*lang) ),
     (x+(16*lang),y+(10*lang),x+(16*lang), y+(14*lang) ),
     (x+(1*lang),y+(11*lang),x+(2*lang), y+(11*lang) ),
     (x+(3*lang),y+(11*lang),x+(4*lang), y+(11*lang) ),
     (x+(6*lang),y+(11*lang),x+(7*lang), y+(11*lang) ),
     (x+(9*lang),y+(11*lang),x+(10*lang), y+(11*lang) ),
     (x+(11*lang),y+(11*lang),x+(16*lang), y+(11*lang) ),
     (x+(1*lang),y+(11*lang),x+(1*lang), y+(15*lang) ),
     (x+(3*lang),y+(11*lang),x+(3*lang), y+(12*lang) ),
     (x+(6*lang),y+(11*lang),x+(6*lang), y+(13*lang) ),
     (x+(7*lang),y+(11*lang),x+(7*lang), y+(12*lang) ),
     (x+(8*lang),y+(11*lang),x+(8*lang), y+(14*lang) ),
     (x+(9*lang),y+(11*lang),x+(9*lang), y+(12*lang) ),
     (x+(11*lang),y+(11*lang),x+(11*lang), y+(12*lang) ),
     (x+(2*lang),y+(12*lang),x+(3*lang), y+(12*lang) ),
     (x+(4*lang),y+(12*lang),x+(5*lang), y+(12*lang) ),
     (x+(10*lang),y+(12*lang),x+(11*lang), y+(12*lang) ),
     (x+(12*lang),y+(12*lang),x+(15*lang), y+(12*lang) ),
     (x+(2*lang),y+(12*lang),x+(2*lang), y+(14*lang) ),
     (x+(4*lang),y+(12*lang),x+(4*lang), y+(17*lang) ),
     (x+(10*lang),y+(12*lang),x+(10*lang), y+(13*lang) ),
     (x+(12*lang),y+(12*lang),x+(12*lang), y+(13*lang) ),
     (x+(15*lang),y+(12*lang),x+(15*lang), y+(14*lang) ),
     (x+(3*lang),y+(13*lang),x+(4*lang), y+(13*lang) ),
     (x+(5*lang),y+(13*lang),x+(10*lang), y+(13*lang) ),
     (x+(11*lang),y+(13*lang),x+(12*lang), y+(13*lang) ),
     (x+(13*lang),y+(13*lang),x+(14*lang), y+(13*lang) ),
     (x+(5*lang),y+(13*lang),x+(5*lang), y+(16*lang) ),
     (x+(13*lang),y+(13*lang),x+(13*lang), y+(14*lang) ),
     (x+(2*lang),y+(14*lang),x+(3*lang), y+(14*lang) ),
     (x+(5*lang),y+(14*lang),x+(7*lang), y+(14*lang) ),
     (x+(8*lang),y+(14*lang),x+(13*lang), y+(14*lang) ),
     (x+(14*lang),y+(14*lang),x+(15*lang), y+(14*lang) ),
     (x+(16*lang),y+(14*lang),x+(18*lang), y+(14*lang) ),
     (x+(3*lang),y+(14*lang),x+(3*lang), y+(16*lang) ),
     (x+(9*lang),y+(14*lang),x+(9*lang), y+(15*lang) ),
     (x+(12*lang),y+(14*lang),x+(12*lang), y+(16*lang) ),
     (x+(14*lang),y+(14*lang),x+(14*lang), y+(16*lang) ),
     (x+(0*lang),y+(15*lang),x+(2*lang), y+(15*lang) ),
     (x+(6*lang),y+(15*lang),x+(8*lang), y+(15*lang) ),
     (x+(10*lang),y+(15*lang),x+(11*lang), y+(15*lang) ),
     (x+(12*lang),y+(15*lang),x+(17*lang), y+(15*lang) ),
     (x+(8*lang),y+(15*lang),x+(8*lang), y+(17*lang) ),
     (x+(10*lang),y+(15*lang),x+(10*lang), y+(17*lang) ),
     (x+(1*lang),y+(16*lang),x+(2*lang), y+(16*lang) ),
     (x+(5*lang),y+(16*lang),x+(7*lang), y+(16*lang) ),
     (x+(9*lang),y+(16*lang),x+(10*lang), y+(16*lang) ),
     (x+(11*lang),y+(16*lang),x+(12*lang), y+(16*lang) ),
     (x+(15*lang),y+(16*lang),x+(17*lang), y+(16*lang) ),
